  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2 p-3 bg-dark border-t border-border">
      <textarea
        ...
        rows={1}
        aria-label="메시지 입력"
        className="flex-1 bg-card border border-border rounded-2xl px-4 py-2 text-sm text-text-primary outline-none focus:border-gold placeholder:text-text-dim resize-none"
        disabled={disabled}
      />
      <button
        type="submit"
