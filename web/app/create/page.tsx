...
import type { UploadedImage, ItemSearchResult } from "@/lib/types";
...
export default function CreateListingPage() {
  ...
  useEffect(() => {
    ...
    const typeStr = form.listingType === "sell" ? "판매" : "구매";
    setForm((f) => ({
      ...f,
      title: `${selectedItem.name}${enhStr} ${typeStr}합니다`,
    }));
  }, [selectedItem, enhancementLevel, form.listingType, titleAutoGenerated]);
  ...
  function handleItemSelect(item: ItemSearchResult) {
    ...
    // Auto-fill category and pre-fill description with item options
    setForm((f) => ({
      ...f,
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="아이템을 선택하면 자동 생성됩니다"
            required
            aria-required="true"
            minLength={2}
          />
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="아이템을 선택하면 옵션이 자동 입력됩니다"
            required
            aria-required="true"
            minLength={10}
          />
